...
const AboutData = {
  ...
  galleryImages: {
    column1: [
      { src: './assets/images/about/1.jpeg', alt: 'Gallery image 1', width: 400, height: 600 },
  ...
  skills: [
    {
      number: '01.',
      category: 'Frameworks',
      description: 'Figma · Adobe Creative Suite (AI, PSD, ID, PR, LR) · Touchdesigner · Blender 3D · Unity · Madmapper · Isadora · Framer · Webflow · Git/GitHub · Microsoft Suite'
    },
    {
      number: '02.',
      category: 'Programming Languages',
      description: 'Python · JavaScript (Node.js, Deno, Express.js) · C++ (Arduino) · C# (Unity) · SQL · HTML/CSS'
    },
    {
      number: '03.',
    ...
    },
    {
      ...
      description: 'OpenAI API · Anthropic API · Google\'s Gemini API · Training text generation models · prompt engineering for text generation · ElevenLabs · text-to-speech · speech-to-text · Runway ML · Stable Diffusion · StyleGANs for image generation · Image generation · ImageFX · MusicFX · Gesture Recognition · Object Detection'
    }
  ],
  ...
  renderGallery() {
    ...
    const columnsHTML = columns.map(columnKey => {
  ...
  renderContactLinks() {
    ...
    const linksHTML = this.contactLinks.map(contact => {
  ...
  renderSkills() {
    ...
    const skillsHTML = this.skills.map((skill, index) => {
      const separator = index < this.skills.length - 1 ? '<div class="skill-separator"></div>' : '';
      return `
    ...
    resumeContent.innerHTML = `
      <div class="skills-wrapper">
        ...
        <div class="download-btn-container">
          ...
          <a
            id="downloadLink"
            href="./assets/images/Creative-Technologist.pdf"

  ...
  projects: [
    {
      ...
      year: '2025',
      description: '"This Machine is a Stranger" is a project that emerged from a curiosity to explore how one can navigate life at the intersection of human intuition and the quiet, calculated logic of autonomous machines, questioning how much a person implicitly trusts or mistrusts a machine.',
      ...
      tools: ['Human-Machine Interactions', 'AI Ethics', 'Interactive Installation']
    },
    {
      id: 'fleeting-states',
      title: 'Fleeting States + Measured Values',
      year: '2024',
      description: 'This project depicts the two sides of quantum computing. The separation of the worlds is analytical. On the one hand, we have the values we can measure, probabilistic results in units. It is how we are trained/used to interact with phenomena. Superpositioning and entanglement on the other hand are neither accessible to our senses nor to measurement. They are states in motion that are truly random.',
      thumbnail: './assets/images/thumbnails/fleeting-states.jpg',
      url: './project-pages/fleeting-states.html',
      categories: ['interactive'],
      tools: ['Quantum physics', 'Multimedia', 'Interactive Installation', 'LED Mapping', 'Science communication']
    },
    {
      id: 'move-a-bit',
      title: 'Move a Bit',
      year: '2022',
      description: 'Move a Bit is a live motion capture project bringing quantum computing to life through an interactive display that visually showcases entanglement.',
      thumbnail: './assets/images/thumbnails/move-a-bit.jpg',
      url: './project-pages/move-a-bit.html',
      categories: ['interactive'],
      tools: ['Quantum computing', 'Motion capture', 'Interactive Installation']
    },
    {
      id: 'computerized-memories',
      title: 'Computerized Memories',
      year: '2023',
      description: '"Computerized memories" is a project that explores the biological structure and psychological character of memory.',
    ...
    },
    {
      ...
      year: '2023',
      description: 'It delves into the story of two people living in the future who send each other postcards because they can\'t see each other. The inherent systems of the society at the time have created physical barriers between them.',
    ...
    },
    {
      ...
      year: '2025',
      description: 'Sights and Insights is a web-based application that transforms ordinary walks into ones filled with curious interventions. It is a voice-based AI application encouraging users to engage with the spaces they find themselves in.',
    ...
    },
    {
      ...
      title: 'Granny Bytes',
      year: '2024',
      description: 'Granny Bytes is a project that explores intergenerational connections and how they can manifest within our interactions with technology.',
    ...
    },
    {
      ...
      categories: ['others'],
      tools: ['3D Modelling', 'Materials and Textures', 'Interactive Environments']
    },
    {
      id: 'warped-memories',
      title: 'Warped Memories of Digital Ghosts',
      year: '2023',
      description: 'This project welcomes you to a world in which people go to a data store to access their digital memories in the form of differently flavored cookies.',
    ...
    },
    {
      ...
      title: 'Hivemind',
      year: '2023',
      description: 'A game about understanding emergent behavior with a playful spirit.',
      thumbnail: './assets/images/thumbnails/hivemind3.png',
      url: './project-pages/hivemind.html',
      categories: ['others'],
      tools: ['Multiplayer game', 'Collaborative game mechanics', 'Emergent systems']
    },
    {
      id: 'vj-set',
      title: 'Audiovisual',
    ...
    },
    {
      ...
      year: '2023',
      description: 'A project that explores concepts of Light and Darkness and the intermittent phases between them through the technique of image generation.',
